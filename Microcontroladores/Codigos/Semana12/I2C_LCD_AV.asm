...
;I2C_LCD_AV.c,3 :: 		void main() {
;I2C_LCD_AV.c,5 :: 		I2C1_Init(100000);
	MOVLW      10
	MOVWF      SSPADD+0
	CALL       _I2C1_Init+0
;I2C_LCD_AV.c,6 :: 		I2C1_Start();
	CALL       _I2C1_Start+0
;I2C_LCD_AV.c,7 :: 		I2C1_Wr(0xA0); //Memoria: 1010000 0
	MOVLW      160
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,8 :: 		I2C1_Wr(0x10);
	MOVLW      16
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,9 :: 		I2C1_Wr('A');
	MOVLW      65
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,10 :: 		I2C1_Wr('L');
	MOVLW      76
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,11 :: 		I2C1_Wr('D');
	MOVLW      68
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,12 :: 		I2C1_Wr('O');
	MOVLW      79
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,13 :: 		I2C1_Wr(' ');
	MOVLW      32
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,14 :: 		I2C1_Wr('P');
	MOVLW      80
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,15 :: 		I2C1_Wr('I');
	MOVLW      73
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,16 :: 		I2C1_Wr('Z');
	MOVLW      90
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,17 :: 		I2C1_Wr('A');
	MOVLW      65
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,18 :: 		I2C1_Wr('R');
	MOVLW      82
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,19 :: 		I2C1_Wr('R');
	MOVLW      82
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,20 :: 		I2C1_Wr('O');
	MOVLW      79
	MOVWF      FARG_I2C1_Wr_data_+0
	CALL       _I2C1_Wr+0
;I2C_LCD_AV.c,21 :: 		I2C1_Stop();
	CALL       _I2C1_Stop+0
;I2C_LCD_AV.c,23 :: 		I2C_LCD_Init();
	CALL       _I2C_LCD_Init+0
;I2C_LCD_AV.c,24 :: 		I2C_LCD_Cmd(_LCD_CLEAR);
	MOVLW      1
	MOVWF      FARG_I2C_LCD_Cmd_out_char+0
	CALL       _I2C_LCD_Cmd+0
;I2C_LCD_AV.c,25 :: 		I2C_LCD_Cmd(_LCD_CURSOR_OFF);
	MOVLW      12
	MOVWF      FARG_I2C_LCD_Cmd_out_char+0
	CALL       _I2C_LCD_Cmd+0
;I2C_LCD_AV.c,26 :: 		I2C_LCD_Out_Cp("Listo");
	MOVLW      ?lstr1_I2C_LCD_AV+0
	MOVWF      FARG_I2C_LCD_Out_Cp_text+0
	CALL       _I2C_LCD_Out_Cp+0
;I2C_LCD_AV.c,27 :: 		while(1){}
L_main18:
	GOTO       L_main18
;I2C_LCD_AV.c,29 :: 		}
L_end_main:
